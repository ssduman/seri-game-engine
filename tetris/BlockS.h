...
public:
    ...
    ~BlockS() override {
        ...
        LOGGER(info, "block S delete succeeded");
    }
...
private:
    void generatePositions() {
        ...
        const auto s1 = createSquarePosition(x - 1.0f, y - 1.0f);
