...
A 2D/3D OpenGL game engine written in C++20, featuring an ECS architecture, PBR lighting, shadow mapping, skeletal animation, and an ImGui-based editor. The engine is under active development.
